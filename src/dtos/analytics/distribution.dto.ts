...
export function createDistributionSchema<T extends z.ZodRawShape>(schema: z.ZodObject<T>) {
  return z.object({
    metric: z.enum(Object.values(MetricType) as [string, ...string[]]).default(''),
    metric_field: z.string(),
    group_by: z.union([z.array(z.string()), z.string()]),
    filter: z
      .string()
      .optional()
      .transform(v => {
...
export type DistributionAnalyticsDto = z.infer<ReturnType<typeof createDistributionSchema>>;
